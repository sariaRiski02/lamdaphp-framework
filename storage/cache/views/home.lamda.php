                ...
                <article class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition transform hover:scale-105">
                    ...
                    <div class="p-5">
                        ...
                        <span class="inline-block bg-blue-100 text-blue-800 text-xs font-semibold px-3 py-1 rounded-full mb-3">
                            <i class="fas fa-tag"></i> <?=  htmlspecialchars($news['category_name'] ?? 'umum', ENT_QUOTES, 'UTF-8') ?>
                        </span>
                        ...
                        <div class="flex items-center justify-between text-gray-500 text-xs mb-4 border-t pt-3">
                            <span><i class="fas fa-calendar"></i><?=  htmlspecialchars($news['created_at'], ENT_QUOTES, 'UTF-8') ?></span>
                            <span><i class="fas fa-user"></i> Admin</span>
                        </div>
                        
                        <!-- Read More Button -->
                        <a href="/news/<?=  htmlspecialchars($news['slug'], ENT_QUOTES, 'UTF-8') ?>" class="inline-block bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded transition w-full text-center">
                            Baca Selengkapnya
                        </a>
                    </div>
                </article>
