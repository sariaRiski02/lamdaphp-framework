                ...
                <div class="group bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-300">
                    ...
                    <div class="p-6">
                        <div class="text-purple-600 font-semibold text-sm mb-2">
                            <i class="fas fa-calendar-alt mr-2"></i>{{ $d['created_at'] }}
                        </div>
                        <h3 class="text-xl font-bold text-gray-800 mb-3">{{ $d['title'] }}</h3>
                        
                        <a href="/detail/{{ $d['id'] }}" class="inline-flex items-center gap-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white px-6 py-2 rounded-full font-semibold hover:shadow-lg hover:scale-105 transition-all duration-300">
